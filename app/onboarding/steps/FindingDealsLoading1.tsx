...
export default function FindingDealsLoading1({ onComplete }: Props) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-black">
      <div className="flex flex-col items-center gap-12 px-8">
        ...
        <div className="text-center">
          <h1 className="mb-3 font-serif text-4xl font-light tracking-wide text-white" style={{ fontFamily: "'Playfair Display', serif" }}>Finding great deals</h1>
        ...
        <div className="mt-4 text-center">
          <p className="font-serif tracking-wide text-neutral-400">Searching thousands of listings from Japan...</p>
        </div>
      </div>
    </div>
  );
